...
| Version | Supported |
| ------- | --------- |
| Latest GitHub Release / pre-release | Yes |
...
1. Affected version (tag or build number)
2. Steps to reproduce
3. Impact (data leak, crash, privilege escalation, etc.)
4. Device / Android version if relevant

## Response Expectations

- Initial acknowledgment: within **7 days**
- Triage and fix timeline: depends on severity; critical issues prioritized
