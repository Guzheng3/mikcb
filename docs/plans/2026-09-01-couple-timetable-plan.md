...
2. 在快照里新增 `couple` 节点：我的今日课表、TA 的今日课表、双方主题色。
...
| 样式 | 尺寸 | 内容 |
|---|---|---|
| 双列今日 | 4x1 或 4x2 | 同一天的两列课表：左侧「我的」，右侧「TA 的」 |
| 双人紧凑 | 2x1 | 同一天的两个人下一节课概览 |

点击行为：

1. 点击「我的」区域，打开课表页并定位到我的课表。
2. 点击「TA 的」区域，打开课表页并定位到 TA 的课表。
3. 两边都使用同一天的日期和周次。
