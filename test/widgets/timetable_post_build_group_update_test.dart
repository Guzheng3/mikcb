...
void main() {
  ...
  testWidgets(
    'post-build course group update lands and notifies on plain week view',
    (tester) async {
      ...
      expect(
        bridged,
        true,
        reason: 'bridge op must land so the gate tail returns to the test zone',
      );
      ...
      expect(
        landed,
        true,
        reason: 'post-build updateCourseGroup must land while frames pump',
      );
      expect(
        notified,
        greaterThan(0),
