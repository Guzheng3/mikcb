...
class MainActivity : FlutterActivity() {
    companion object {
        ...
        private const val SYSTEM_DOWNLOAD_CHANNEL = "vip.qinghan.withu/system_download"
        private const val MIGRATION_CHANNEL = "vip.qinghan.withu/migration"
        ...
        private const val ICS_CHANNEL = "vip.qinghan.withu/ics_import"
        private const val FROSTED_BLUR_CHANNEL = "vip.qinghan.withu/frosted_blur"
        private const val LAUNCH_URL_CHANNEL = "vip.qinghan.withu/launch_url"
        private const val HAPTIC_CHANNEL = "vip.qinghan.withu/haptic"
        private const val SYSTEM_ALARM_CHANNEL = "vip.qinghan.withu/system_alarm"
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, METHOD_CHANNEL)
            ...
            .setMethodCallHandler { call, result ->
                when (call.method) {
                    ...
                    // 岛左侧文字标签等能力只在小米系下发（见
                    // LiveUpdateService.resolveIslandLabelBitmap 的 isXiaomiFamilyDevice
                    // 门控）。界面用同一判据隐藏无效项，故共用 liveSurfaceBrand，
                    // 避免两处品牌规则各自漂移。
                    "isXiaomiFamilyDevice" -> result.success(
